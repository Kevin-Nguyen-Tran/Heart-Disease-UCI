...
ggplot(tidy_data, mapping = aes( x = status, y = age)) +
  ...
  labs(x = "Disease Status", 
       y = "Age",
       title = "Older Age Correlated with Heart Disease",
       subtitle = "Heart Disease UCI",
       caption = "Source: https://archive.ics.uci.edu/ml/datasets/heart+Disease") +
  theme(plot.title = element_text(hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5))
...
This analysis is aligned with the claims stated above from [@maas2010gender]. The average age of males with heart disease was on average 3 years less than that of a female, which supports the claim that men tend to develop coronary artery disease earlier in life. If we look at the youngest male to develop heart disease, they are 8 years younger than the youngest female with heart disease in this data set. Which supports the claim that heart disease "develops 7-10 years later in women than in men."

## Cholestoral Levels and Disease Status

The research by [@elshourbagy2014cholesterol] explains that atherosclerosis is an inflammatory condition that can result from a multitude of risk factors. Some known factors that can contribute to its development are high levels of Low-Density Lipoprotein (LDL) and low levels of High-Density Lipoprotein (HDL). The reason is because LDL is a pro-inflammatory and HDL is an anti-inflammatory. 

Because atherosclerosis is a leading cause of cardiovasular disease due to dyslipidemia (abnormal levels of lipids in the blood (LDL/HDL)) [@elshourbagy2014cholesterol], we will analyze the cholesterol data of our patients. 
...
According to [heart.org](https://www.heart.org/en/health-topics/heart-attack/angina-chest-pain), *"not all chest pain is a sign of heart disease."* There are other conditions that can cause chest pains, such as, Pulmonary Embolism, Aortic Dissection, Lung infection, Aortic Stenosis, and etc.

**Therefore, as seen above, we can assume that chest pain might not be a great indicator for heart disease as well within this data set.**
...
The [heart.org](https://www.heart.org/en/health-topics/heart-attack/angina-chest-pain) states that normal ranges of systolic blood pressure is less than 120 mm Hg. Systolic blood pressure that is consistently greater than 130 mmHg categorizes the patient as hypertensive.
...
* The first plot shows a line that is relatively flat and the relationship between the fitted values and residuals is cloud shaped. This implies linearity between the three variables of age, maximum heart rate achieved, and disease status.
